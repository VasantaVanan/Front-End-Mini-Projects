...
function generateCat() {
	...
	image.src = "https://media.tenor.com/images/82517b1fbf01e0db1c2636319e2c6965/tenor.gif";
...
function rpsGame(yourChoice) {
	...
	console.log('Computer chocie:', botChoice);
	
	results = decideWinner(humanChoice, botChoice); // win or lose
	console.log(results); 
	
	message = finalMessage(results[0]); // {'message': "You won!", 'color': "green"}
	console.log(message);
